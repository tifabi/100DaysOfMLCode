...
Simple Linear Regression is __definition__. It is useful for __uses__. A simple linear regression line can be calculated in R as seen in R code below:
